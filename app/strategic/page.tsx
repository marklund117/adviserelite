...
export default function Strategic() {
     return <Container size="xl" className="min-h-[100vh]">
        <h1 className="text-[40px] text-center pt-10 pb-7">Strategic Advisory Services</h1>
        <p className="mb-1 mt-3">Scott is here to help you navigate the upper echelons of leadership. Standing outside of your organization's hierarchy, he can serve as an empathetic and honest truth-teller, supporting and challenging you to accelerate your professional and personal success.</p>
        <p className="mb-1 mt-3">Individual strategy sessions can be tailored to high level long-term planning, detailed tactical decisions, or anything in between. Example focus areas include:</p>
